            ...
            {!giftSuccessMsg ? (
              <div>
                ...
                <div className="space-y-6">
                  {/* Pix Option */}
                  <div className="bg-pink-50/80 border-2 border-pink-300 rounded-2xl p-4">
                    <h4 className="font-extrabold text-pink-950 text-sm flex items-center gap-2 mb-2">
                    ...
                    <div className="bg-white p-3 rounded-xl border border-pink-300 flex items-center justify-between gap-2 shadow-sm">
                      ...
                      <button
                        onClick={() => copyPixCode('12814531700')}
